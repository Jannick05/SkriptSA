...
public class ExprPercentageDecrease extends SimpleExpression<Double> {

    static {
        Skript.registerExpression(ExprPercentageDecrease.class, Double.class, ExpressionType.SIMPLE, "(fald fra|fall from) %double% (til|to) %double%");
    }
    ...
    protected @Nullable Double[] get(Event event) {
        ...
        Double newNumber = localNumber - localNumber2;
    ...
    public String toString(@Nullable Event event, boolean b) {
        return "Calculation of percentage drop";
    }
