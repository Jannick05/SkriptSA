...
public class ExprPercentageChange extends SimpleExpression<Double> {

    static {
        Skript.registerExpression(ExprPercentageChange.class, Double.class, ExpressionType.SIMPLE, "(hvad er|what is) %double% (procent af|percent of) %double%");
    }
    ...
    public String toString(@Nullable Event event, boolean b) {
        return "Calculation of percentage change";
    }
