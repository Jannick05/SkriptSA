...
public class ExprFindInteger extends SimpleExpression<Double> {

    static {
        Skript.registerExpression(ExprFindInteger.class, Double.class, ExpressionType.SIMPLE, "%double% (er|is) %double% (procent af hvad|percent of what)");
    }
    ...
    public String toString(@Nullable Event event, boolean b) {
        return "Calculation of the whole number";
    }
